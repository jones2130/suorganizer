...
from .views import NewsLinkCreate, NewsLinkDelete, NewsLinkUpdate, StartupCreate, StartupDelete, StartupUpdate, TagCreate, TagDelete, TagUpdate, startup_detail, startup_list, tag_detail, tag_list
