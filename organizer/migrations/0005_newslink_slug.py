# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-04-10 14:51
...
def add_slug_data(apps, schema_editor):
    ...
    for newslink in query:
        ...
        if rivals > 0:
            strn_len = (SLUG_LENGTH - len(str(rivals)))
